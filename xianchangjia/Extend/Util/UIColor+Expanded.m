...
+ (UIColor *)colorWithString:(NSString *)stringToConvert {
	...
	switch (i) {
		case 1:
			color = [UIColor colorWithRed:c[0]/255.0 green:c[0]/255.0 blue:c[0]/255.0 alpha:1];
			break;
		case 2: // monochrome
			color = [UIColor colorWithWhite:c[0]/255.0 alpha:c[1]];
			break;
		case 3:
			color = [UIColor colorWithRed:c[0]/255.0 green:c[1]/255.0 blue:c[2]/255.0 alpha:1];
			break;
		case 4: // RGB
